...
The Root Edit process begins with an SKYBASE token holder submitting a proposal through the Powerhouse system containing a draft Artifact Edit Proposal. An SKYBASE token holder must hold at least 1% of the circulating token supply to submit a proposal. The proposal must also be posted on the Sky Forum under the “Skybase Prime” category.
...
This Instance’s associated Instance Configuration Document is located at [A.6.1.1.4.2.5.1.2.1 - Skybase Frontend App Instance Configuration Document](b52f88c6-427b-45f6-8e1c-81fa27e522c8).
...
This Instance’s associated Instance Configuration Document is located at [A.6.1.1.4.2.5.1.2.2 - Skybase Frontend Open Source Widgets Instance Configuration Document](5aada153-29f6-4304-b56e-9d425dc978a4).
...
This Instance uses the Tracking Methodology specified in [A.2.3.8.1.2.1.2.2.1 - Ethereum Mainnet General Tracking Methodology](87fd6861-ba8a-4bde-945e-ee9ad37ae3e2).
...
Distribution Reward payments for this Instance are settled through the Monthly Settlement Cycle (MSC) process. See [A.1.9 - Monthly Settlement Cycle](uuid-placeholder) for the MSC settlement methodology.
